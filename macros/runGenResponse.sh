...
#runxstoolmar16v1r5
time
mt="../microtrees/mar16/job_NeutAirAllSystV5_out/allMerged.root"
wd="../weights/outdir/cc0piv27Mar16NeutAirV2/"
...
source /home/dolan/.bashrc
runxstoolmar16v1r5
cd /data/t2k/dolan/xsToolBasedMEC/CC0PiAnl/reweightMacros  	
echo "Processing xsToolXsSig mode on topo ${topo} and reac ${reac}"
root -b -q -l "genResponse_dpt.C(\"${mt}\",\"${wd}\",\"NXSec_MaCCQE\"       ,0.95,0.14,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_dpt.C(\"${mt}\",\"${wd}\",\"NIWG2014a_pF_C12\"   ,1.03,0.15,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_dpt.C(\"${mt}\",\"${wd}\",\"NIWGMEC_Norm_C12\"   ,0.27,0.73,${topo},${reac})" > /dev/null
# Ignore Oxygen Params for the moment
#root -b -q -l "genResponse_dpt.C(\"${mt}\",\"${wd}\",\"NIWG2014a_pF_O16\"   ,1.21,0.45,${topo},${reac})" > /dev/null
#root -b -q -l "genResponse_dpt.C(\"${mt}\",\"${wd}\",\"NIWGMEC_Norm_O16\"   ,1.21,0.45,${topo},${reac})" > /dev/null
#root -b -q -l "genResponse_dpt.C(\"${mt}\",\"${wd}\",\"NIWG2014a_Eb_O16\"   ,1.21,0.45,${topo},${reac})" > /dev/null
EOF
...
root -b -q -l "genResponse_dpt.C(\"${mt}\",\"${wd}\",\"NXSec_CA5RES\"       ,1.00,0.12,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_dpt.C(\"${mt}\",\"${wd}\",\"NXSec_MaNFFRES\"     ,1.00,0.16,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_dpt.C(\"${mt}\",\"${wd}\",\"NXSec_BgSclRES\"     ,1.00,0.15,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_dpt.C(\"${mt}\",\"${wd}\",\"NIWG2012a_ccnueE0\"  ,1.00,0.02,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_dpt.C(\"${mt}\",\"${wd}\",\"NIWG2012a_dismpishp\",1.00,0.40,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_dpt.C(\"${mt}\",\"${wd}\",\"NIWG2012a_cccohE0\"  ,1.00,1.00,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_dpt.C(\"${mt}\",\"${wd}\",\"NIWG2012a_nccohE0\"  ,1.00,0.30,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_dpt.C(\"${mt}\",\"${wd}\",\"NIWG2012a_ncotherE0\",1.00,0.30,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_dpt.C(\"${mt}\",\"${wd}\",\"NIWG2014a_Eb_C12\"   ,1.00,0.36,${topo},${reac})" > /dev/null
EOF
...
cd /data/t2k/dolan/xsToolBasedMEC/CC0PiAnl/reweightMacros  	
echo "Processing xsToolXsBkg mode on topo ${topo} and reac ${reac}"
root -b -q -l "genResponse_dpt.C(\"${mt}\",\"${wd}\",\"NCasc_FrInelHigh_pi\",1.00,0.33,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_dpt.C(\"${mt}\",\"${wd}\",\"NCasc_FrInelLow_pi\" ,1.00,0.41,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_dpt.C(\"${mt}\",\"${wd}\",\"NCasc_FrPiProd_pi\"  ,1.00,0.50,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_dpt.C(\"${mt}\",\"${wd}\",\"NCasc_FrAbs_pi\"     ,1.00,0.41,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_dpt.C(\"${mt}\",\"${wd}\",\"NCasc_FrCExLow_pi\"  ,1.00,0.57,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_dpt.C(\"${mt}\",\"${wd}\",\"NCasc_FrCExHigh_pi\" ,1.00,0.28,${topo},${reac})" > /dev/null
EOF
...
root -b -q -l "genResponse_dpt.C(\"../microtrees/mar16/job_NeutAirAllSystV4_out/allMerged.root\",\
                                 	      \"../weights/outdir/cc0piv27Mar16NeutAirV2/\",\
                                 	      \"NXSec_MaCCQE\",1.21,0.45,${topo},${reac})" > /dev/null
EOF
...
root -b -q -l "genResponse_dpt.C(\"../microtrees/mar16/job_NeutAirAllSystV4_out/allMerged.root\",\
                                 \"../weights/outdir/cc0piv27Mar16NeutAirV2/\",\
                                 \"NXSec_MaNFFRES\",1.41,0.21,${topo},${reac})" > /dev/null
EOF
qsub MARES_T${topo}R${reac}.sh
	  done
	done
...
root -b -q -l "genResponse_dpt.C(\"../microtrees/mar16/job_NeutAirAllSystV4_out/allMerged.root\",\
                                 \"../weights/outdir/cc0piv27Mar16NeutAirV2/\",\
                                 \"NCasc_FrInelHigh_pi\",1.0,0.338,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_dpt.C(\"../microtrees/mar16/job_NeutAirAllSystV4_out/allMerged.root\",\
                                 \"../weights/outdir/cc0piv27Mar16NeutAirV2/\",\
                                 \"NCasc_FrInelLow_pi\",1.0,0.412,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_dpt.C(\"../microtrees/mar16/job_NeutAirAllSystV4_out/allMerged.root\",\
                                 \"../weights/outdir/cc0piv27Mar16NeutAirV2/\",\
                                 \"NCasc_FrPiProd_pi\",1.0,0.500,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_dpt.C(\"../microtrees/mar16/job_NeutAirAllSystV4_out/allMerged.root\",\
                                 \"../weights/outdir/cc0piv27Mar16NeutAirV2/\",\
                                 \"NCasc_FrAbs_pi\",1.0,0.412,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_dpt.C(\"../microtrees/mar16/job_NeutAirAllSystV4_out/allMerged.root\",\
                                 \"../weights/outdir/cc0piv27Mar16NeutAirV2/\",\
                                 \"NCasc_FrCExLow_pi\",1.0,0.567,${topo},${reac})" > /dev/null
root -b -q -l "genResponse_dpt.C(\"../microtrees/mar16/job_NeutAirAllSystV4_out/allMerged.root\",\
                                 \"../weights/outdir/cc0piv27Mar16NeutAirV2/\",\
                                 \"NCasc_FrCExHigh_pi\",1.0,0.278,${topo},${reac})" > /dev/null
EOF
qsub MARES_T${topo}R${reac}.sh
	  done
	done
...
if [ $1 == 'RES' ]; then
	for topo in 1 2 3 5 6 7 8 9; do
	  for reac in 0 1 2 3 4 5 7; do
	    ...
	    root -b -q -l "genResponse_dpt.C(\"../microtrees/mar16/job_NeutAirAllSystV4_out/allMerged.root\",\
	                                     \"../weights/outdir/cc0piv27Mar16NeutAirV2/\",\
	                                     \"NXSec_MaRES\",1.41,0.21,${topo},${reac})" > /dev/null
	    root -b -q -l "genResponse_dpt.C(\"../microtrees/mar16/job_NeutAirAllSystV4_out/allMerged.root\",\
	                                     \"../weights/outdir/cc0piv27Mar16NeutAirV2/\",\
	                                     \"NIWG2012a_cc1piE0\",1.0,0.43,${topo},${reac})" > /dev/null
	    root -b -q -l "genResponse_dpt.C(\"../microtrees/mar16/job_NeutAirAllSystV4_out/allMerged.root\",\
	                                     \"../weights/outdir/cc0piv27Mar16NeutAirV2/\",\
	                                     \"NIWG2012a_cc1piE1\",1.0,0.40,${topo},${reac})" > /dev/null
	    root -b -q -l "genResponse_dpt.C(\"../microtrees/mar16/job_NeutAirAllSystV4_out/allMerged.root\",\
	                                     \"../weights/outdir/cc0piv27Mar16NeutAirV2/\",\
	                                     \"NIWG2012a_dismpishp\",1.0,0.40,${topo},${reac})" > /dev/null
	    root -b -q -l "genResponse_dpt.C(\"../microtrees/mar16/job_NeutAirAllSystV4_out/allMerged.root\",\
	                                     \"../weights/outdir/cc0piv27Mar16NeutAirV2/\",\
	                                     \"NIWG2012a_nc1pi0E0\",1.0,0.40,${topo},${reac})" > /dev/null
	  done
	done
fi
