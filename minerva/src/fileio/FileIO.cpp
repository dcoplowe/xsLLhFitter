...
void FileIO::Init()
{
   ...
   fChain->SetBranchAddress("truth_pi0_bkg", &truth_pi0_bkg, &b_truth_pi0_bkg);
   fChain->SetBranchAddress("truth_isNewSigDef", &truth_isNewSigDef, &b_truth_isNewSigDef);
   fChain->SetBranchAddress("truth_isSignal", &truth_isSignal, &b_truth_isSignal);
   fChain->SetBranchAddress("truth_isSignal_MultiPi0", &truth_isSignal_MultiPi0, &b_truth_isSignal_MultiPi0);
   ...
   fChain->SetBranchAddress("truth_gamma1_bkg_pdg", &truth_gamma1_bkg_pdg, &b_truth_gamma1_bkg_pdg);
   fChain->SetBranchAddress("truth_gamma2_bkg_pdg", &truth_gamma2_bkg_pdg, &b_truth_gamma2_bkg_pdg);
   fChain->SetBranchAddress("truth_muon_bkg_pdg", &truth_muon_bkg_pdg, &b_truth_muon_bkg_pdg);
   ...
   fChain->SetBranchAddress("truth_proton_bkg_pdg", &truth_proton_bkg_pdg, &b_truth_proton_bkg_pdg);
   ...
   fChain->SetBranchAddress("truth_pi0_cos_openingAngle", &truth_pi0_cos_openingAngle, &b_truth_pi0_cos_openingAngle);
   fChain->SetBranchAddress("truth_pi0_openingAngle", &truth_pi0_openingAngle, &b_truth_pi0_openingAngle);
   ...
   fChain->SetBranchAddress("proton__nNodes", &proton__nNodes, &b_proton__nNodes);
   ...
   fChain->SetBranchAddress("muon_X_startpos", &muon_X_startpos, &b_muon_X_startpos);
   fChain->SetBranchAddress("muon_Y_startpos", &muon_Y_startpos, &b_muon_Y_startpos);
   fChain->SetBranchAddress("muon_Z_startpos", &muon_Z_startpos, &b_muon_Z_startpos);
   ...
   fChain->SetBranchAddress("proton_ln_Q0", &proton_ln_Q0, &b_proton_ln_Q0);
   fChain->SetBranchAddress("proton_ln_Q1", &proton_ln_Q1, &b_proton_ln_Q1);
   fChain->SetBranchAddress("proton_ln_Q2", &proton_ln_Q2, &b_proton_ln_Q2);
   fChain->SetBranchAddress("proton_ln_Q3", &proton_ln_Q3, &b_proton_ln_Q3);
   fChain->SetBranchAddress("proton_ln_Q4", &proton_ln_Q4, &b_proton_ln_Q4);
   fChain->SetBranchAddress("proton_ln_Q5", &proton_ln_Q5, &b_proton_ln_Q5);
   ...
   fChain->SetBranchAddress("muon_XPos_allNodes_sz", &muon_XPos_allNodes_sz, &b_muon_XPos_allNodes_sz);
   fChain->SetBranchAddress("muon_XPos_allNodes", muon_XPos_allNodes, &b_muon_XPos_allNodes);
   fChain->SetBranchAddress("muon_X_allNodes_sz", &muon_X_allNodes_sz, &b_muon_X_allNodes_sz);
   fChain->SetBranchAddress("muon_X_allNodes", muon_X_allNodes, &b_muon_X_allNodes);
   fChain->SetBranchAddress("muon_YPos_allNodes_sz", &muon_YPos_allNodes_sz, &b_muon_YPos_allNodes_sz);
   fChain->SetBranchAddress("muon_YPos_allNodes", muon_YPos_allNodes, &b_muon_YPos_allNodes);
   fChain->SetBranchAddress("muon_Y_allNodes_sz", &muon_Y_allNodes_sz, &b_muon_Y_allNodes_sz);
   fChain->SetBranchAddress("muon_Y_allNodes", muon_Y_allNodes, &b_muon_Y_allNodes);
   fChain->SetBranchAddress("muon_ZPos_allNodes_sz", &muon_ZPos_allNodes_sz, &b_muon_ZPos_allNodes_sz);
   fChain->SetBranchAddress("muon_ZPos_allNodes", muon_ZPos_allNodes, &b_muon_ZPos_allNodes);
   fChain->SetBranchAddress("muon_Z_allNodes_sz", &muon_Z_allNodes_sz, &b_muon_Z_allNodes_sz);
   fChain->SetBranchAddress("muon_Z_allNodes", muon_Z_allNodes, &b_muon_Z_allNodes);
   ...
   fChain->SetBranchAddress("WSq", &WSq, &b_WSq);
   fChain->SetBranchAddress("W", &W, &b_W);
   fChain->SetBranchAddress("deltaInvMass_reco", &deltaInvMass_reco, &b_deltaInvMass_reco);
   fChain->SetBranchAddress("delta_pi_theta_reco", &delta_pi_theta_reco, &b_delta_pi_theta_reco);
   fChain->SetBranchAddress("delta_pi_phi_reco", &delta_pi_phi_reco, &b_delta_pi_phi_reco);
   fChain->SetBranchAddress("muon_pT", &muon_pT, &b_muon_pT);
   fChain->SetBranchAddress("proton_pT", &proton_pT, &b_proton_pT);
   fChain->SetBranchAddress("pion_pT", &pion_pT, &b_pion_pT);
   fChain->SetBranchAddress("total_proton_KE", &total_proton_KE, &b_total_proton_KE);
   fChain->SetBranchAddress("dpTT_true", &dpTT_true, &b_dpTT_true);
   fChain->SetBranchAddress("dpT_true", &dpT_true, &b_dpT_true);
   fChain->SetBranchAddress("dalphaT_true", &dalphaT_true, &b_dalphaT_true);
   fChain->SetBranchAddress("dphiT_true", &dphiT_true, &b_dphiT_true);
   fChain->SetBranchAddress("Enu_true", &Enu_true, &b_Enu_true);
   fChain->SetBranchAddress("QSq_true", &QSq_true, &b_QSq_true);
   fChain->SetBranchAddress("WSq_true", &WSq_true, &b_WSq_true);
   fChain->SetBranchAddress("W_true", &W_true, &b_W_true);
   fChain->SetBranchAddress("deltaInvMass_true", &deltaInvMass_true, &b_deltaInvMass_true);
   fChain->SetBranchAddress("delta_pi_theta_true", &delta_pi_theta_true, &b_delta_pi_theta_true);
   fChain->SetBranchAddress("delta_pi_phi_true", &delta_pi_phi_true, &b_delta_pi_phi_reco_true);
   fChain->SetBranchAddress("muon_pT_true", &muon_pT_true, &b_muon_pT_true);
   fChain->SetBranchAddress("proton_pT_true", &proton_pT_true, &b_proton_pT_true);
   fChain->SetBranchAddress("pion_pT_true", &pion_pT_true, &b_pion_pT_true);
   fChain->SetBranchAddress("total_proton_KE_true", &total_proton_KE_true, &b_total_proton_KE_true);
