    ...
    const string &cuts, const double precision)
{
    ...
    tot_bin[ (x_nbins - 1 ) ] = GetEntriesInRange(intree, var_name, binning[ x_nbins ], x_max, cuts); 
...
int SystematicsBase::GetEntriesInRange(TTree * tree, const std::string &var_name, const double x_min, const double x_max, const std::string &cuts)
{
