...
int main(int argc, char *argv[])
{
  ...
  string fsel     = inputDir + "/NeutAirInputTree.root";
  string fakeData     = inputDir + "/NeutAirInputTree.root";
  ...
  string fxsecbinning = inputDir + "/dptbinning.txt";
    ...
    switch(cc)
    {
      ...
      case 'h': //help
        std::cout << "USAGE: "
                  ...
                  << "-r : \tset (fake) data location" << std::endl
