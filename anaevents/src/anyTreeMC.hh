...
class anyTreeMC
{
    ...
    TBranch        *b_piMomRec;   //!
    TBranch        *b_piMomTrue;   //!
    TBranch        *b_piCosThetaRec;   //!
    TBranch        *b_piCosThetaTrue;   //!
...
void anyTreeMC::Init()
{
    ...
    fChain->SetBranchAddress("piMomRec", &piMomRec, &b_piMomRec);
    fChain->SetBranchAddress("piMomTrue", &piMomTrue, &b_piMomTrue);
    fChain->SetBranchAddress("piCosThetaRec", &piCosThetaRec, &b_piCosThetaRec);
    fChain->SetBranchAddress("piCosThetaTrue", &piCosThetaTrue, &b_piCosThetaTrue);
